...
public interface AddressRepository extends JpaRepository<DistrictModel, Integer> {
    ...
    List<AddressResponseDto> getAllGovernorates(String language);
    ...
    List<AddressResponseDto> getCitiesInGovernorate(String language, int governorateId);
    ...
    List<AddressResponseDto> getDistrictsInCity(String language, int cityId);
